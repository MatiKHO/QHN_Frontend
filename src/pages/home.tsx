...
const HomePage = () => {
  return (
    <DefaultLayout>
      {/* Categorías */}
      <section className="w-full flex justify-around flex-wrap gap-4 py-8 md:py-10">
        ...
        {siteConfig.categories.map((category) => {
          ...
          return (
            ...
            key={category.label}
            isPressable
            className="w-[100px] py-4 px-4 hover:scale-105 transition-transform duration-300"
          >
            <CardHeader className="pb-0 pt-2 px-4 flex-col items-center">
              <Icon className="2-6 h-6 mb-2" />
